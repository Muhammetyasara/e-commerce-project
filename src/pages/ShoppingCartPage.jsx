...
export default function ShoppingCartPage() {
  ...
  return (
    <section className="bg-stone-100 min-h-screen">
      ...
      <main className="p-4 md:p-8 lg:p-16 flex flex-col justify-center items-center">
        <button
        ...
        <h1 className="text-2xl font-bold mb-6 self-start">Sepetim ({cart.length} Ürün)</h1>
        <div className="border rounded-lg bg-slate-200 p-4 self-start mb-4 font-bold flex gap-3">
        ...
        {cart.length > 0 && (
          <div className="mt-8 bg-white p-4 rounded border flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4 w-full max-w-4xl">
            <div className="text-sm">
              <span className="font-semibold">
                Seçili ürünler: {totalItemsSelected}
              </span>
            </div>
            <div className="text-sm font-semibold">Toplam: {totalAmount} ₺</div>
          </div>
        )}
      </main>
