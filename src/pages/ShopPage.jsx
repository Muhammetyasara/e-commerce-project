...
export default function ShopPage() {
  ...
  const icons = [siGoogle, siReddit, siLyft, siActivision, siApple, siSamsung];
  ...
  return (
    ...
    `}
      ...
      <div className="pt-20 flex flex-col gap-16 items-center text-stone-500 lg:flex-row lg:px-56 lg:pt-0">
        {icons.map((icon) => (
          <svg
            key={icon.title}
            viewBox="0 0 24 24"
            className="h-52 w-52 fill-current"
